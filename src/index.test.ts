...
import { ServiceYear, ServiceType, Actions } from "./models";
...
describe("updateSelectedServices.select", () => {
  test("should select when not selected", () => {
    const result = selectedServicesReducer([], {
      type: "Select",
      service: "Photography",
    });
  ...
  test("should not select the same service twice", () => {
    const result = selectedServicesReducer(["Photography"], {
      type: "Select",
      service: "Photography",
    });
    expect(result).toEqual(["Photography"]);
  ...
  test("should not select related service when main service is not selected", () => {
    const result = selectedServicesReducer(["WeddingSession"], {
      type: "Select",
  ...
  test("should select related service when main service is selected", () => {
    const result = selectedServicesReducer(["WeddingSession", "VideoRecording"], {
      type: "Select",
      service: "BlurayPackage",
    });
  ...
  test("should select related service when one of main services is selected", () => {
    const result = selectedServicesReducer(["WeddingSession", "Photography"], {
      type: "Select",
      service: "TwoDayEvent",
    });
...
describe("updateSelectedServices.deselect", () => {
  ...
  test("should deselect related when last main service deselected", () => {
    const result = selectedServicesReducer(["WeddingSession", "Photography", "TwoDayEvent"], {
      type: "Deselect",
      service: "Photography",
    });
    expect(result).toEqual(["WeddingSession"]);
  ...
  test("should not deselect related when at least one main service stays selected", () => {
    const result = selectedServicesReducer(["WeddingSession", "Photography", "VideoRecording", "TwoDayEvent"], {
      type: "Deselect",
      service: "Photography",
    });
...
//   [2022, 0],
// ])(
//   "calculatePrice.photographyWithWeddingSessionPrice (%i increase by %i)",
...
//   [2022, 300],
// ])(
//   "calculatePrice.videoRecordingWithWeddingSessionPrice (%i increase by %i)",
//   (year: ServiceYear, increase) => {
//     test("price matches requirements", () => {
...
//   [2022, 600],
// ])(
//   "calculatePrice.videoRecordingWithPhotographyPrice (%i increase by %i)",
//   (year: ServiceYear, increase) => {
//     test("price matches requirements", () => {
